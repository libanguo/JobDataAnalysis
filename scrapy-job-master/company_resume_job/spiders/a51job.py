...
class A51jobSpider(RedisSpider):
    ...
    # 基地址
    urls = ['https://search.51job.com/list/000000,000000,0100%252c7200%252c7300%252c7800%252c7500,00,9,99,+,2,'
    ...
    def detail_parse(self, response):
        ...
        # 公司类型
        job['co_type'] = response.xpath('//div[@class="tCompanyPage"]//div[@class="com_tag"]/p[1]/text()').extract()[0]
        # 公司行业
        job['co_trade'] = response.xpath('//div[@class="tCompanyPage"]//div[@class="com_tag"]//p//'
                                         'span[@class="i_trade"]/following-sibling::a[1]/text()').extract()[0]
        yield job
